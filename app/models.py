...
TOPIC_CHOICES = [('Proposal', 'P'), ('Online Only', 'O')]
...
# 27th August 'published' is not currently in uses, but keep it rather than alter the database 
